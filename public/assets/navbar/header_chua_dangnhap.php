...
<nav id="navBar" class="bg-white/30 flex flex-row items-center text-sm
    ...
    ?>
            <div class="w-3/12 flex justify-end">
                ...
                <a href="register.php" class="flex my-auto"><button type="button" class="text-[13px] mr-5 lg:block hidden hover:text-[#F15E2C] duration-300">Đăng ký</button></a>
                <a href="login.php"><button type="button" class="MT_button_header">Đăng nhập</button></a>
    ...
    <div class="flex my-auto mx-auto">
        <div class="mx-8 flex flex-row space-x-[2vw]">
            ...
            <a href="#" class="flex flex-col bg-white hover:bg-Cam_Ananas hover:text-white rounded-lg w-auto h-auto items-center shadow-md hover:shadow-lg hover:scale-105 duration-300">
                <img src="../../../public/assets/navbar/forwomen.jpg" class="w-52 aspect-square rounded-t-lg object-cover">
                <div class="flex content-between py-4">CHO NỮ</div>
            </a>

            <a href="#" class="flex flex-col bg-white hover:bg-Cam_Ananas hover:text-white rounded-lg w-auto h-auto items-center shadow-md hover:shadow-lg hover:scale-105 duration-300">
                <img src="../../../public/assets/navbar/shirt.jpg" class="w-52 aspect-square rounded-t-lg object-cover">
                <div class="flex content-between py-4">ÁO</div>
            </a>

            <a href="#" class="flex flex-col bg-white hover:bg-Cam_Ananas hover:text-white rounded-lg w-auto h-auto items-center shadow-md hover:shadow-lg hover:scale-105 duration-300">
                <img src="../../../public/assets/navbar/acc.jpg" class="w-52 aspect-square rounded-t-lg object-cover">
...
<div id="mobileNav" class="md:invisible hidden w-full h-[calc(100%-48px)] fixed z-30 top-12 bg-white/30 backdrop-blur">
    <div class="flex flex-col my-16 space-y-9 w-9/12 mx-auto">
        ...
        <div class="flex space-x-5">
            <button class="w-1/2 bg-white h-14 rounded-lg shadow-md"><a href="register.php">Đăng ký</a></button>
            <button class="w-1/2 bg-[#F15E2C] h-14 rounded-lg shadow-md text-white"><a href="login.php">Đăng nhập</a></button>
        </div>
