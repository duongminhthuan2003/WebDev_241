                                ...
                                <table class="min-w-full border-collapse border border-gray-300 text-black">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td class="border border-gray-300 px-4 py-2 text-center"><?= htmlspecialchars($customer['user_name']); ?></td>
                                            <td class="border border-gray-300 px-4 py-2 text-center"><?= htmlspecialchars((new DateTime($customer['birth_date']))->format('d.m.Y')); ?></td>
                                            <td class="border border-gray-300 px-4 py-2 text-center"><?= htmlspecialchars($customer['email_address']); ?></td>
                                            <td class="border border-gray-300 px-4 py-2 text-center"><?= htmlspecialchars($customer['phone_number']); ?></td>
                                            <td class="border border-gray-300 px-4 py-2 text-center"><?= htmlspecialchars($customer['detail']); ?>, <?= htmlspecialchars($customer['ward']); ?>, <?= htmlspecialchars($customer['district']); ?>, <?= htmlspecialchars($customer['province']); ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
