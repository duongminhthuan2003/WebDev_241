...
<div class="flex-grow">
    <div class="flex flex-row w-9/12 mx-auto mt-8">
        <div class="md:flex flex-col items-start w-4/12 mr-6 hidden">
        ...
        <div class="flex md:flex-row flex-col">
            <img src="/assets/account/Sequoia-Sunrise.png" alt="Account Image" class="md:h-28 md:mr-6 md:w-28 my-auto aspect-square object-cover rounded-full
            h-56 mx-auto w-56">
            ...
            <div class="my-auto space-y-7">
                <form method="POST" action="/info/submit">
                    ...
                    <div class="space-x-5 md:space-x-0 md:space-y-7 flex flex-row md:flex-col">
