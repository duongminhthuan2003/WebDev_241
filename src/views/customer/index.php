...
<nav class="bg-white/30 flex flex-row items-center text-sm
    ...
    <div class="w-3/5 align-middle">
        <ul class="md:flex flex-row justify-center space-x-12 hidden">
            ...
            <li><a href="/order" class="hover:text-[#F15E2C] cursor-pointer transition-all">TEST DON HANG</a></li>
            <li><a href="/customers" class="hover:text-[#F15E2C] cursor-pointer transition-all">TEST KHACH HANG</a></li>
            <li><a href="/products" class="hover:text-[#F15E2C] cursor-pointer transition-all">TEST SAN PHAM</a></li>
