                    ...
                    <col1 class="w-2/6 pl-40 space-y-5 hidden lg:block">
                        ...
                        <ul class="space-y-5 pl-6">
                            ...
                            <li class="">
                                <div class="flex items-center space-x-2">
                                    <input type="checkbox" id="option1" class="form-checkbox h-5 w-5">
                                    <label for="option1" class="font-BeVietnam">Tote bag</label>
                                </div>
                            </li>
                            <li class="">
                                <div class="flex items-center space-x-2">
                                    <input type="checkbox" id="option1" class="form-checkbox h-5 w-5">
                                    <label for="option1" class="font-BeVietnam">Graphic Tee</label>
                                </div>
                            </li>
                            <li class="">
                                <div class="flex items-center space-x-2">
                                    <input type="checkbox" id="option1" class="form-checkbox h-5 w-5">
                                    <label for="option1" class="font-BeVietnam">Hoodie</label>
                                </div>
                            </li>
                            <li class="">
                                <div class="flex items-center space-x-2">
                                    <input type="checkbox" id="option1" class="form-checkbox h-5 w-5">
                                    <label for="option1" class="font-BeVietnam">Shocks | Vớ</label>
                                </div>
                            </li>
                            <li class="">
                                <div class="flex items-center space-x-2">
                                    <input type="checkbox" id="option1" class="form-checkbox h-5 w-5">
                                    <label for="option1" class="font-BeVietnam">Hat</label>
                                </div>
                            </li>
                            <li class="">
                                <div class="flex items-center space-x-2">
                                    <input type="checkbox" id="option1" class="form-checkbox h-5 w-5">
                                    <label for="option1" class="font-BeVietnam">Effec Tee</label>
                                </div>
                            </li>
                            <li class="">
                                <div class="flex items-center space-x-2">
                                    <input type="checkbox" id="option1" class="form-checkbox h-5 w-5">
                                    <label for="option1" class="font-BeVietnam">Hip Pack</label>
                                </div>
                            </li>
                            <li class="">
                                <div class="flex items-center space-x-2">
                                    <input type="checkbox" id="option1" class="form-checkbox h-5 w-5">
                                    <label for="option1" class="font-BeVietnam">Trucker Hat</label>
                                </div>
                            </li>
                            <li class="">
                                <div class="flex items-center space-x-2">
                            ...
                            <li class="">
                                <div class="flex items-center space-x-2">
                                    <input type="checkbox" id="option1" class="form-checkbox h-5 w-5">
                                    <label for="option1" class="font-BeVietnam">Shoelaces</label>
                                </div>
                            </li>
                        </ul>
                        <div class="font-BeVietnam font-bold ML_text_cam">
                        ...
                        <ul class="space-y-5 pl-6">
                            <li class="">
                                <div class="flex items-center space-x-2">
                                    <input type="checkbox" id="option1" class="form-checkbox h-5 w-5">
                                    <label for="option1" class="font-BeVietnam">imited Edition</label>
                                </div>
                            </li>
                            <li class="">
                                <div class="flex items-center space-x-2">
